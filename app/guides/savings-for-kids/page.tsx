...
const bullets = [
  "למה רוב ההורים מפסידים עשרות אלפי שקלים בלי לדעת",
  "איך לעבור למסלול השקעה שמכפיל את הסכום",
  "הצעד הפשוט שלוקח 10 דקות ומשנה הכל",
  "איך הקהילה שלנו הרוויחה במצטבר מיליוני שקלים",
];
  ...
  return (
    <main dir="rtl" style={{ minHeight: "100vh", background: "radial-gradient(ellipse at 50% 20%, #1535B5 0%, #060D3C 65%)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "60px 1.5rem 80px" }}>
      ...
      <div style={{ maxWidth: 520, width: "100%", textAlign: "center" }}>
        ...
        <p style={{ color: "#21F0B0", fontWeight: 700, fontSize: "1.1rem", marginBottom: 8 }}>
          להפוך 20,000 ש״ח ל-70,000 ש״ח
        </p>
        <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.95rem", marginBottom: 28, lineHeight: 1.6 }}>
          המדריך שהרוויח לקהילה במצטבר מיליוני שקלים
        </p>
