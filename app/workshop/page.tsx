...
const lectureTopics = [
  {
    ...
    desc: "פנסיה, השתלמות, גמל, חיסכון לכל ילד - את כבר מושקעת בכמה אפיקי השקעה שונים ולא ידעת. נבין מה כל אחד מהם עושה לכסף שלך, למה השקעה פאסיבית מנצחת לטווח הארוך, ולמה זה הכי רלוונטי לחיים שלך ממש עכשיו.",
  },
  {
  ...
  },
  {
    ...
    desc: "לפני שזזות - מבינות מה רמת הסיבולת התנודתית שלך, כי לא כל השקעה מתאימה לכולן. ואז יוצאות עם רשימה ברורה של מה עושים עכשיו - מותאם בדיוק לך.",
  },
];
...
const workshopTopics = [
  ...
  },
  {
    ...
    desc: "מבינות מה זה מדד, למה השקעה פאסיבית מנצחת, ואיך שיטת ההשקעה DCA עושה את כל העבודה. בונות יחד תיק מותאם לחיים שלך - לפי סיבולת הסיכון, המטרות והזמן שיש לך.",
  },
  {
    title: "האסטרטגיה שלך - מותאמת בדיוק לך",
    desc: "מסלולי השקעה, סיבולת תנודתית, ויעול התיק הפיננסי שיש לך כבר. יש כאלה שיפתחו תיק מסחר עצמאי, יש כאלה שיעדיפו לשדרג קרן השתלמות או לשנות מסלול בפנסיה. יוצאת עם אסטרטגיה ארוכת טווח שמתאימה למטרות שלך - לא של מישהי אחרת.",
  },
];
