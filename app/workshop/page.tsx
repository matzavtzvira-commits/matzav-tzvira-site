...
const lectureTopics = [
  {
    title: "כולנו מושקעות - גם אם לא ידעת",
    desc: "הפנסיה שלך כבר בשוק ההון. מי שמבינה איך זה עובד - מרוויחה. מי שלא - מפסידה בלי לדעת. נבין מה קורה עם הכסף שלנו ואיך מנצלות את זה.",
  },
  {
    title: "ריבית דריבית - למה המוח לא מסוגל להכיל את הכוח הזה",
    desc: "הפלא השמיני של העולם. נראה מספרים אמיתיים שמסבירים למה כל שנה שעוברת בלי ידע שווה לך עשרות אלפי שקלים.",
  },
  {
    title: "מאות אלפי שקלים - מה עושות מחר בבוקר",
    desc: "נמחיש כמה עלה לנו חוסר הידע עד היום - ונצא עם צעדים קונקרטיים שכל אחת יכולה לעשות כבר השבוע.",
  },
];

const workshopTopics = [
  {
    title: "עקרונות ההשקעה הפאסיבית שעובדים",
    desc: "מה צריך לדעת - ולא יותר. נבנה יחד בסיס ברור ופשוט שמספיק כדי להתחיל להרוויח.",
  },
  {
    title: "פותחות תיק השקעות ביחד - יד ביד",
    desc: "כל משתתפת פותחת תיק השקעות פעיל בזמן אמת. מינוף כל מה שיש - בצורה נכונה ובטוחה.",
  },
  {
    title: "התיק שלך - מותאם בדיוק לך",
    desc: "בונות יחד תיק פאסיבי שמתאים לחיים, למטרות ולרמת הסיכון שלך. יוצאת עם משהו שעובד.",
  },
];
