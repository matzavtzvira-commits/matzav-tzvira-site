...
const articles = [
  ...
  { slug: "meitav-vs-fair", title: "מיטב או פייר - ההשוואה הכנה", excerpt: "מינימום 250 ₪ או 5,000 ₪? בונוס של 100 ₪ או אפס דמי משמרת? ההשוואה המלאה + מדריך עם צילומי מסך - כדי שתדעי לאן ללכת.", date: "מאי 2026", tag: "השקעות", tagColor: "#124AF0", views: v(0, 3) },
  ...
  { slug: "open-trading-account", title: "איך פותחים חשבון מסחר עצמאי - מדריך שלב אחר שלב", excerpt: "לפתוח חשבון מסחר זה קל יותר מלקבוע תור לרופא שיניים. מדריך מלא עם כל השלבים - פחות מ-15 דקות, מהבית, עם הטבה של 100 ש\"ח.", date: "מאי 2026", tag: "השקעות", tagColor: "#124AF0", views: v(659, 7) },
