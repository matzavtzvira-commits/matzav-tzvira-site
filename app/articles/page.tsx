...
const kidsArticles = [
  { slug: "savings-for-kids", title: "חיסכון לכל ילד - המדריך השלם", excerpt: "מ-2017 המדינה מפקידה כסף לכל ילד. ההפרש בין המסלול הנכון לברירת המחדל - 57,000 ₪ לכל ילד. כולל מדריך ניוד שלב-אחר-שלב.", date: "מאי 2026", tag: "ילדים", tagColor: "#21F0B0", views: v(881, 6) },
];
...
const articles = [
  ...
  { slug: "har-hakessef", title: "הר הכסף - כך תמצאי כסף שלא ידעת שיש לך", excerpt: "מעל 8 מיליארד ש\"ח מחכים לבעליהם. פנסיות ישנות, ביטוחי חיים שנשכחו, חשבונות שנסגרו. בדיקה של 5 דקות שיכולה לגלות עשרות אלפי שקלים.", date: "מאי 2026", tag: "הר הכסף", tagColor: "#FA5C5C", views: v(235, 3) },
                ...
                a.comingSoon ? (
                  ...
                  >
                    {a.slug === "har-hakessef" ? (
                      ...
                      <div style={{ background: "radial-gradient(ellipse at 50% 40%, #1535B5 0%, #060D3C 80%)", height: 160, overflow: "hidden", position: "relative" }}>
                        <video src="/guides/mashkanta-video.mp4" autoPlay loop muted playsInline style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center center", display: "block" }} />
