...
const articles = [
  { slug: "bitcoin-guide", title: "המדריך הפרקטי לביטקוין: לעשות סדר בבלאגן", excerpt: "כולם מדברים על ביטקוין. חלק מפחדים, חלק נלהבים - ורוב הנשים לא יודעות מה לחשוב. מדריך ברור, בלי ז'רגון ובלי פחד.", date: "מאי 2026", tag: "השקעות", tagColor: "#124AF0" },
