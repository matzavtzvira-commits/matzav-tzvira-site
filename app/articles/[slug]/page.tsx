...
const articles: Record<string, {
  ...
  "open-trading-account": {
    title: "פתיחת תיק השקעות - וההבדלים בין הפלטפורמות המובילות",
    date: "מאי 2026",
    tag: "השקעות",
    tagColor: "#124AF0",
    readTime: "15 דקות קריאה",
    heroVideo: "/guides/open-account-video.mp4",
    viewCount: 659,
    viewInc: 7,
    intro: "לפתוח תיק השקעות עצמאי זה קל יותר מלקבוע תור לרופא שיניים.\n\nברצינות.\n\nהרבה נשים שאני מכירה דחו את זה חצי שנה, שנה, ולפעמים יותר - כי זה נשמע מורכב ומפחיד. אחרי שהן עשו את זה? הן צחקו על עצמן.\n\nכל התהליך לוקח בין 10 ל-15 דקות. מהמחשב בבית. בכוס קפה לצד.\n\nבמדריך הזה - גם ההסבר המלא וגם ההשוואה בין 5 הפלטפורמות המובילות.",
    sections: [
      {
      ...
      },
      {
        ...
        tableData: {
          ...
          rows: [
            ...
            ["דמי ניהול", "0.07% עד 0.3%", "0%", "0.8% בממוצע"],
      ...
      },
      {
        ...
        platformCards: [
          ...
          },
          {
            ...
            bonus: "עמלה 0.06% - הנמוכה בהשוואה",
            bullets: ["מינימום פתיחה: 10,000 ₪", "פטור מדמי טיפול", "ללא עמלה על קרנות נאמנות ותעודות סל"],
            link: "https://www.psagotrade.com/en/metzavtsbira/",
            linkLabel: "לפתיחת חשבון בפסגות ←",
          },
        ],
      },
      {
        heading: "השוואה מלאה - 5 הפלטפורמות זו מול זו",
        body: "רוצה לראות הכל במבט אחד? הנה הפירוט המלא.\nההטבות זמינות דרך הכרטיסים למעלה - תחת המטריה הפיננסית.",
        tableData: {
          headers: ["", "מיטב", "פייר", "IBI", "אלטשולר", "פסגות"],
          rows: [
            ["מינימום לפתיחת חשבון", "5,000 ₪", "250 ₪", "15,000 ₪", "5,000 ₪", "10,000 ₪"],
            ["דמי משמרת חודשיים", "פטור לשנתיים (דרך הלינק)", "0 ₪ תמיד", "פטור לשנתיים (דרך הלינק)", "0 ₪ תמיד", "פטור מדמי טיפול"],
            ["עמלת קרנות מחקות", "0.08% (מינ' 4.65 ₪)", "0.08% (מינ' 3 ₪)", "0.08% (מינ' 5 ₪)", "0.07% (מינ' 2.9 ₪)", "ללא עמלה"],
            ["מסלול הלכה", "כן", "כן", "כן", "כן", "כן"],
            ["הוראת קבע אוטומטית", "אין", "יש", "יש", "יש", "יש"],
            ["בונוס פתיחה דרך הלינק שלי", "100 ₪ מתנה", "-", "300 ₪ + קורס מבוא + פטור דמי טיפול לשנתיים", "200 ₪ מתנה", "פטור מדמי טיפול"],
          ],
        },
      },
      {
      ...
      {
        heading: "שלב אחר שלב - פתיחת חשבון מיטב",
      ...
      },
      {
        ...
        body: "מינימום 250 ₪ בלבד.\nאפס דמי משמרת לתמיד, מסלול הלכה זמין.\nמתחילות קטן - ומשקיעות בקצב שלכן.\n\nגילוי נאות: אני מרוויחה עמלה מפתיחת חשבון דרך הלינק.",
        link: "https://www.fair.co.il/%D7%A4%D7%9C%D7%98%D7%A4%D7%95%D7%A8%D7%9E%D7%AA-%D7%94%D7%A9%D7%A7%D7%A2%D7%95%D7%AA-%D7%93%D7%99%D7%92%D7%99%D7%98%D7%9C%D7%99%D7%AA/?utm_source=nwsp_matzavtzvira",
        linkLabel: "לפתיחת חשבון בפייר ←",
      },
      {
      ...
      },
      {
        ...
        links: [
          ...
          { href: "https://www.psagotrade.com/en/metzavtsbira/", label: "פסגות - עמלה 0.06% ←" },
        ],
      },
    ],
  },
  ...
  "bitcoin-guide": {
    ...
    sections: [
      ...
      },
      {
        ...
        link: "/articles/open-trading-account",
        linkLabel: "מדריך פתיחת תיק השקעות + השוואת הפלטפורמות ←",
      },
    ],
  },
  "meitav-vs-fair": {
    ...
    sections: [
      ...
      {
        heading: "מדריכים עם צילומי מסך - מיטב ופייר",
  ...
  "mashkanta-check": {
    ...
    sections: [
      ...
      {
        heading: "נחמי שלזינגר שלחה דוח אחד - וחסכה 310,000 ש\"ח",
        body: "\"ראיתי את המאמר, אמרתי מה יש לי להפסיד. בדיוק הייתי במשרד - הורדתי את הדוח ושלחתי למלכי.\n\nאחרי כמה ימים היא חזרה אליי שהיא יכולה לחסוך לי במשכנתא 310,000 ש\"ח. כן, המספר נכון - פשוט מטורף.\n\nרבקי, אין לי מילים. להעלאת המודעות הזו אין מחיר. מחזרנו כמובן, ואני לא יודעת איך להודות לך. תודה תודה תודה.\"\n\n- נחמי שלזינגר",
      },
      {
        ...
        link: "/guides/mashkanta-guide.pdf",
...
const draftSlugs: string[] = ["mischar-vs-gemel", "keren-hishtalmut", "meitav-vs-fair", "savings-for-kids-niyud"];
