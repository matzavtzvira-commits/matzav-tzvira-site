  ...
  "har-hakessef": {
    ...
    sections: [
      ...
      },
      {
        ...
        images: [
          { src: "/guides/har-hakessef/page2.png", alt: "השוואת תשואה: 30,000 ש\"ח במסלול 3% לעומת 10% לאורך 30 שנה" },
        ],
      },
      {
      ...
      },
      {
        ...
        body: "שלב 1 - נכנסות לאתר הרשמי\nharhakosef.mof.gov.il - לא דרך גוגל, ישירות לכתובת.\n\nשלב 2 - מזינות תעודת זהות\nהאתר מציג את כל הנכסים הפיננסיים שלא נדרשו על שמכן. רשימה מלאה, מיידית.\n\nשלב 3 - בודקות מה מצאתן\nלוחצות על כל ממצא ורואות פרטים - שם הגוף המחזיק, סכום משוער, פרטי יצירת קשר.\n\nשלב 4 - פונות לגוף המחזיק\nכל גוף שמופיע ברשימה - צרו איתו קשר ישירות. הם חייבות לטפל בפנייה.\n\nשלב 5 - מחליטות מה לעשות\nלמשוך? להעביר לפנסיה הנוכחית? לשנות מסלול? תלוי בסכום, בגיל, ובמצב הפיננסי שלכן.",
        images: [
          { src: "/guides/har-hakessef/page3.png", alt: "7 שלבים להשתמש בשירות הר הכסף באתר הממשלתי" },
        ],
        link: "https://www.gov.il/he/service/pension_savings_search",
