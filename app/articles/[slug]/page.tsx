...
const articles: Record<string, {
  ...
  "meitav-vs-fair": {
    title: "מיטב או פייר - ההשוואה הכנה",
    date: "מאי 2026",
    tag: "השקעות",
    tagColor: "#124AF0",
    ...
    viewCount: 0,
    viewInc: 3,
    intro: "לפתוח חשבון מסחר זה לא מסובך.\nהשאלה היחידה שנשארת: מיטב או פייר?\n\nשתיהן מוסדרות, שתיהן בעברית, שתיהן עם מסלול הלכה.\nההבדל הוא בפרטים - ואלה הפרטים שחשוב לדעת.",
    sections: [
      {
        ...
        tableData: {
          ...
          rows: [
            ...
            ["דמי משמרת חודשיים", "פטור לשנתיים (דרך הלינק)", "0 ₪ תמיד"],
            ["עמלת קרנות מחקות", "0.08% (מינימום 4.65 ₪)", "0.08% (מינימום 3 ₪)"],
            ["מסלול הלכה", "כן", "כן"],
            ["בונוס פתיחה דרך הלינק שלי", "100 ₪ מתנה", "-"],
            ["מתאים ל...", "סכום 5,000 ₪ ומעלה", "כל סכום מ-250 ₪"],
          ],
        },
      },
      {
