...
const articles: Record<string, {
  ...
  "meitav-vs-fair": {
    title: "מיטב, פייר או IBI - ההשוואה הכנה",
    date: "מאי 2026",
    tag: "השקעות",
    tagColor: "#124AF0",
    ...
    viewCount: 0,
    viewInc: 3,
    intro: "לפתוח חשבון מסחר זה לא מסובך.\nהשאלה היחידה שנשארת: איזה בית השקעות?\n\nמיטב, פייר ו-IBI - שלושתן מוסדרות, שלושתן בעברית.\nההבדל הוא בפרטים - ואלה הפרטים שחשוב לדעת.",
    sections: [
      {
        heading: "ההשוואה - בלי עיגולים",
        body: "",
        tableData: {
          headers: ["", "מיטב", "פייר", "IBI"],
          rows: [
            ["מינימום לפתיחת חשבון", "5,000 ₪", "250 ₪", "15,000 ₪"],
            ["דמי משמרת חודשיים", "פטור לשנתיים (דרך הלינק)", "0 ₪ תמיד", "פטור לשנתיים (דרך הלינק)"],
            ["עמלת קרנות מחקות", "0.08% (מינ' 4.65 ₪)", "0.08% (מינ' 3 ₪)", "0.08% (מינ' 5 ₪)"],
            ["מסלול הלכה", "כן", "כן", "כן"],
            ["הוראת קבע אוטומטית", "אין", "יש", "יש"],
            ["בונוס פתיחה דרך הלינק שלי", "100 ₪ מתנה", "-", "300 ₪ + קורס מבוא + פטור דמי טיפול לשנתיים"],
          ],
        },
      },
      {
        heading: "מה מתאים לך?",
        body: "שאלי את עצמך שאלה אחת:\nכמה כסף את מתכננת להפקיד בהתחלה?\n\nפחות מ-5,000 ₪ - פייר עדיפה.\nמינימום 250 ₪, אפס דמי משמרת לתמיד, ומשם את גדלה בקצב שלך.\n\n5,000 ₪ ומעלה - מיטב עדיפה.\nהבונוס של 100 ₪ + פטור דמי ניהול לשנתיים = הטבה משמעותית בהתחלה.\n\nלא בטוחה? תפתחי פייר עם 250 ₪.\nתתרגלי, תראי שזה עובד, ותחליטי הלאה.",
      },
      {
