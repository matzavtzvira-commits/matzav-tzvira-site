...
function SolutionReveal() {
  const services = [
    ...
    { n: 6, name: "החזר המס שלך",  sub: "כסף שכבר שילמת - חוזר אלייך",   desc: "הרבה שכירות זכאיות להחזר מס - ולא יודעות. יועצת מס שאני עובדת איתה בודקת לך זכאות עד 6 שנים אחורה, בלי עלות. אם מגיע לך החזר, היא עושה את כל הביורוקרטיה ישירות מולך - ומשלמים לה רק מתוך הכסף שחוזר. לא חזר כלום? לא שילמת." },
  ];
  return (
...
function ValueStack() {
  const items = [
    ...
    { icon: "", name: "החזר המס שלך",  action: "יועצת מס בודקת זכאות עד 6 שנים אחורה - בדיקה ללא עלות",       value: "ממוצע ההחזר בענף: כ-10,500 ש\"ח", ctx: "בדיקת הזכאות חינם. אם מגיע החזר, התשלום ליועצת רק מתוך הכסף שחוזר - לא מראש. לא כל אחת זכאית, תוצאות משתנות." },
    ...
    { icon: "", name: "בדיקת התיק הפיננסי שלך",  action: "עוברות על כל האפיקים שלך - פנסיה, קרן השתלמות וגמל - ועושות סדר מקצועי: פיזור נכון וחכם, מסלולים כשרים, והתאמה מקסימלית לגיל, לאופי ולרמת הסיכון שלך",  value: "התאמה מדויקת - בלי לשלם על מה שלא מתאים לך", ctx: "" },
    { icon: "", name: "החיסכון לכל ילד",  action: "בודקות שהחיסכון וההשקעה של כל ילד יושבים במקום הנכון, בפיזור חכם - דואגות שלא כל הכסף יושב באפיק אחד",  value: "עוד עשרות אלפי שקלים שמחכים לכל ילד", ctx: "תוצאות משתנות." },
  ];
  return (
