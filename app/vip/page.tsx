...
function SolutionReveal() {
  const services = [
    ...
    { n: 2, name: "כרית הנשימה",     sub: "רזרבת ביטחון פסיכית",            desc: "בונות לך גב כלכלי שיחזיק אותך גם ביום שהעסק מתנדנד או שתרצי לעצור. את ממשיכה לישון." },
...
function ValueStack() {
  const items = [
    ...
    { icon: "", name: "כרית הנשימה",   action: "רזרבת ביטחון שחוסכת הלוואות חירום",          value: "עשרות אלפי שקלים בהלוואות שלא תצטרכי לקחת", ctx: "ריבית 15-20% שנחסכת" },
  ];
  return (
