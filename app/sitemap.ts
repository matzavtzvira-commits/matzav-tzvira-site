...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${SITE_URL}/articles/savings-for-kids`,                    lastModified: new Date("2026-05-01"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/articles/har-hakessef`,                        lastModified: new Date("2026-05-14"), changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE_URL}/articles/open-trading-account`,                lastModified: new Date("2026-05-01"), changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE_URL}/articles/bitcoin-guide`,                       lastModified: new Date("2026-05-01"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_URL}/articles/mashkanta-check`,                     lastModified: new Date("2026-06-01"), changeFrequency: "monthly", priority: 0.8 },
