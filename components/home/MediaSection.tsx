  ...
  return (
    <section style={{ background: "#FFFFFF", padding: "72px 1.5rem" }}>
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        {/* Three cards */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 28 }} className="media-grid">
          ...
          <motion.div
            ...
            <div style={{ height: 200, overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/logo-kol-kvoda.png" alt="קול כבודה" style={{ width: "100%", height: "100%", objectFit: "contain", display: "block", padding: "24px" }} />
            </div>
            {/* Content */}
            <div style={{ padding: "28px 28px 32px", display: "flex", flexDirection: "column", gap: 16, flex: 1 }}>
              <div>
              ...
              <a href="https://kollkvoda.co.il/62015/" target="_blank" rel="noopener noreferrer"
                style={{ marginTop: "auto", color: "#124AF0", fontWeight: 700, fontSize: "0.95rem", display: "flex", alignItems: "center", gap: 6 }}>
                לקריאת הטור <span className="arrow-anim">←</span>
              </a>
            </div>
