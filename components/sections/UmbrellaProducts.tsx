          ...
          {products.map((p, i) => (
            ...
            >
              ...
              <div style={{ padding: "22px 24px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                <Link href={p.href} style={{ display: "block", textAlign: "center", background: "#124AF0", color: "#fff", borderRadius: 50, padding: "13px 24px", fontWeight: 700, fontSize: "0.95rem", textDecoration: "none" }}>{p.cta}</Link>
              </div>
            </motion.div>
          ))}
        </div>
