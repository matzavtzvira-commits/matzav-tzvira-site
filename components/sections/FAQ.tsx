...
const faqs = [
  ...
  {
    q: "אין לי כסף פנוי כרגע - זה בשבילי?",
    a: "בדיוק בשבילך. את לא צריכה כסף פנוי - את צריכה לדעת איפה הכסף שכבר יש לך הולך לאיבוד. פנסיה, קרן השתלמות, חיסכון לכל ילד - הכסף כבר שם, רק לא עובד בשבילך. התוכנית הזו לא מבקשת ממך להשקיע יותר. היא מלמדת אותך לנהל את מה שכבר יש לך.",
  },
  {
