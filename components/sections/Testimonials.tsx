...
const testimonials = [
  ...
  {
    quote: "האמת? חשבתי שכבר מאוחר מדי לשנות משהו. בגיל 52, אחרי התוכנית, הבנתי סוף־סוף כמה דמי הניהול גוזלים ממני בכל חודש. נכנסתי לפעולה, השוויתי, ביקשתי הצעות חדשות - והצלחתי להוריד את דמי הניהול ביותר מ-70%. המשמעות? רווח של כ-675,000 ₪ לפנסיה שלי.",
  ...
  {
    quote: "אנחנו משקיעות שנים בלימודים ובעבודה, אבל שוכחות להשקיע מינימום זמן כדי להבין איפה הכסף שלנו נמצא. כל בחורה שיוצאת לחיים חייבת את התוכנית הזו. ההבדל בין לדעת לבין בורות - שווה מאות אלפי שקלים.",
    name: "מיכל שרעבי",
